          ...
          >
            <div className="flex gap-4 pb-4" style={{ width: 'max-content' }}>
              {packageKeys.map((key, packageIndex) => (
                <motion.div
                  key={key}
                  className={`rounded-lg shadow-sm min-w-[280px] max-w-[280px] h-[800px] flex flex-col ${getCardStyle(key)}`}
                ...
                >
                  ...
                  {/* Card Content - Sin scroll, espacio suficiente */}
                  <div className="p-4 flex-grow">
                    <div className="space-y-3">
                      {features.map((feature, featureIndex) => {
                        const value = packages[key].values[featureIndex];
                        if (value === "-") return null; // No mostrar características no incluidas
                        
                        // Para valores que son solo checkmarks, mostrar solo la característica
                        if (value === "✓") {
                          return (
                        ...
                        // Para valores específicos, mostrar la característica con el valor integrado
                        return (
                          <div key={featureIndex} className="flex items-start gap-3 py-1.5">
                  ...
                  {/* Card Footer - Siempre al final y fijo */}
